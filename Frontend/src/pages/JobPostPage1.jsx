...
export default function IndeedEmployerPage() {
  ...
  const handleNext = () => {
    const { companyName, fullName, phone, referralSource } = formData;
    if (!companyName || !fullName || !phone || !referralSource) {
      setError("Please fill in all required fields.");
      return;
    }
    setError("");
    localStorage.setItem("jobFormStep1", JSON.stringify(formData));
    navigate("/addJobDetails2");
  };
