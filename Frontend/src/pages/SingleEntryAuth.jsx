...
//           <Link to="/cookie-policy" className="text-blue-700 hover:underline font-medium">Cookie</Link>, and{" "}
//           <Link to="/privacy-policy" className="text-blue-700 hover:underline font-medium">Privacy</Link> policies.
//         </div>
...
//             <div>
//               <label htmlFor="otp" className="block text-base font-semibold text-gray-900 mb-4">
//                 Enter OTP
//               </label>
//               <div
...
const SingleEntryAuth = () => {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      showAlert("error", err?.response?.data?.message || "Failed to resend OTP");
    } finally {
