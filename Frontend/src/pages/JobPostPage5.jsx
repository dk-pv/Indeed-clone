...
export default function IndeedEmployerPage() {
  ...
  const handleBack = () => {
    navigate("/addJobDetails4"); // optional: change route if needed
  };
  ...
  const handleContinue = () => {
    ...
    const existingData = JSON.parse(localStorage.getItem("jobPostData")) || {};
    const updatedData = {
      ...existingData,
      jobDescription,
    };

    localStorage.setItem("jobPostData", JSON.stringify(updatedData));

    navigate("/addJobDetails6");
  };
