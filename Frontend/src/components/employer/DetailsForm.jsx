    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-6">
          ...
          <p className="text-blue-100">Specify the type of position and hiring details</p>
        </div>
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="px-8 py-6 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 mb-4">Select all that apply to this position</p>
            <div className="flex flex-wrap gap-3">
              {jobTypes?.map((type) => (
                <button
                  key={type}
            ...
            {errors.jobTypes && (
              <div className="flex items-center space-x-2 mt-3">
                ...
                <p className="text-red-600 text-sm font-medium">{errors.jobTypes.message}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <label className="block text-lg font-bold text-gray-800">Schedule</label>
            <p className="text-sm text-gray-600 mb-4">Choose the work schedules that apply (optional)</p>
            <div className="flex flex-wrap gap-3">
              {visibleSchedules?.map((schedule) => (
                <button
                  key={schedule}
          ...
          <div className="space-y-3 pt-4 border-t border-gray-100">
            ...
            <p className="text-sm text-gray-600 mb-3">How many people do you want to hire for this position?</p>
            ...
            {errors.numberOfPeople && (
              <div className="flex items-center space-x-2 mt-2">
                ...
                <p className="text-red-600 text-sm font-medium">{errors.numberOfPeople.message}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600 mb-3">When do you need to fill this position?</p>
            <div className="relative">
              <select
                {...register("recruitmentTimeline", {
                  required: "Please select a recruitment timeline",
            ...
            {errors.recruitmentTimeline && (
              <div className="flex items-center space-x-2 mt-2">
                ...
                <p className="text-red-600 text-sm font-medium">{errors.recruitmentTimeline.message}</p>
              </div>
            )}
          </div>
