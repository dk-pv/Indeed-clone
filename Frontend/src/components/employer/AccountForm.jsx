  ...
  const handleFormSubmit = async (data) => {
    try {
      ...
      if (missingFields.length > 0) {
        showAlert("error", `Please fill in the following required fields: ${missingFields.join(", ")}`);
        return;
      }
      ...
      if (formData?.phone) {
        ...
        if (phoneDigits.length < 10) {
          showAlert("error", "Please enter a valid phone number with at least 10 digits.");
          return;
        }
      }
      ...
      showAlert("error", "Something went wrong. Please try again or contact support.");
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-6">
          ...
          <p className="text-blue-100">Join thousands of employers finding great talent</p>
        </div>
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {errors.companyName && (
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  <p className="text-red-600 text-sm font-medium">{errors.companyName.message}</p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                {...register("fullName", { 
                  required: "Full name is required",
                  minLength: { value: 3, message: "Please enter both first and last name" },
                  pattern: {
                    value: /^[a-zA-Z\s'-]+$/,
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="online_video">Online video</option>
                  <option value="mail">Mail</option>
                  <option value="streaming_audio">Streaming audio (e.g., Spotify, Pandora)</option>
                  <option value="tv">TV</option>
                  <option value="word_of_mouth">Word of mouth</option>
                  <option value="search_engine">Search engine (e.g., Google, Bing, Yahoo)</option>
                  <option value="newspaper">Newspaper</option>
                  <option value="radio">Radio (AM/FM/XM)</option>
                  <option value="billboard">Billboard</option>
                  <option value="podcast">Podcast</option>
              ...
              {errors.referralSource && (
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  <p className="text-red-600 text-sm font-medium">{errors.referralSource.message}</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-4">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  <span className="font-semibold">By continuing, you agree to Indeed's</span>{" "}
                  <a href="/terms" className="text-blue-700 hover:text-blue-800 hover:underline font-medium transition-colors">
                    Terms of Service
                  </a>
                  ,{" "}
                  <a href="/privacy" className="text-blue-700 hover:text-blue-800 hover:underline font-medium transition-colors">
                    Privacy Policy
                  </a>
                  , and{" "}
                  <a href="/cookie" className="text-blue-700 hover:text-blue-800 hover:underline font-medium transition-colors">
                    Cookie Policy
                  </a>
                  .
                </p>
