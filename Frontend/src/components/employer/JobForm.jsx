    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-6">
          ...
          <p className="text-blue-100">Tell us about the position you're posting</p>
        </div>
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="px-8 py-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            {errors.jobTitle && (
              <div className="flex items-center space-x-2 mt-2">
                ...
                <p className="text-red-600 text-sm font-medium">{errors.jobTitle.message}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {errors.jobDescription && (
              <div className="flex items-center space-x-2 mt-2">
                ...
                <p className="text-red-600 text-sm font-medium">{errors.jobDescription.message}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Job Location</h3>
            ...
            <div className="space-y-2">
              ...
              {errors.locationType && (
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  <p className="text-red-600 text-sm font-medium">{errors.locationType.message}</p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.city && (
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  <p className="text-red-600 text-sm font-medium">{errors.city.message}</p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-2">
                ...
                {errors.pincode && (
                  <div className="flex items-center space-x-2 mt-2">
                    ...
                    <p className="text-red-600 text-sm font-medium">{errors.pincode.message}</p>
                  </div>
                )}
              </div>
            </div>
